...
def generate_pdf_report(filters, metrics, df_rinci, fig_tren, fig_pie):
    ...
    metric_data = [['Total Warga (Sesuai Filter)', f": {metrics['total_warga']}"], ['Jumlah Kehadiran', f": {metrics['hadir_hari_ini']}"], ['Tingkat Partisipasi', f": {metrics['partisipasi_hari_ini']:.1f}%"]]
    ...
    data_rinci_table.setStyle(TableStyle([('BACKGROUND', (0,0), (-1,0), colors.grey), ('TEXTCOLOR', (0,0), (-1,0), colors.whitesmoke), ('ALIGN', (0,0), (-1,-1), 'CENTER'), ('FONTNAME', (0,0), (-1,0), 'Helvetica-Bold'), ('BOTTOMPADDING', (0,0), (-1,0), 12), ('BACKGROUND', (0,1), (-1,-1), colors.beige), ('GRID', (0,0), (-1,-1), 1, colors.black)]))
